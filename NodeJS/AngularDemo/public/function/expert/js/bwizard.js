			...
			if (o.activeIndex >= 0 && o.activeIndex <= this.lis.length - 1) {
				if (this.lis) {
					...
					switch (o.activeIndex) {
						case 0:
							this.lis.eq(o.activeIndex).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll 0px 0px"});
							this.lis.eq(1).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -46px -52px"});
							this.lis.eq(2).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -184px -52px"});
							this.lis.eq(3).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -92px -52px"});
							this.lis.eq(4).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -138px -52px"});

							break;
							case 1:
							this.lis.eq(o.activeIndex).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -46px 0px"});
							this.lis.eq(0).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll 0px -52px"});
							this.lis.eq(2).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -184px -52px"});
							this.lis.eq(4).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -138px -52px"});
							this.lis.eq(3).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -92px -52px"});
							break;
							case 2:
							this.lis.eq(o.activeIndex).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -184px 0px"});
							this.lis.eq(0).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll 0px -52px"});
							this.lis.eq(1).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -46px -52px"});
							this.lis.eq(4).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -138px -52px"});
							this.lis.eq(3).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -92px -52px"});
							break;
							case 3:
							this.lis.eq(o.activeIndex).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -92px 0px"});
							this.lis.eq(0).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll 0px -52px"});
							this.lis.eq(1).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -46px -52px"});
							this.lis.eq(2).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -184px -52px"});
							this.lis.eq(4).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -138px -52px"});
							break;
							case 4:
							this.lis.eq(o.activeIndex).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -138px 0px"});
							this.lis.eq(0).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll 0px -52px"});
							this.lis.eq(1).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -46px -52px"});
							this.lis.eq(2).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -184px -52px"});
							this.lis.eq(3).find("div").css({"background":"url('function/expert/img/flow.png') no-repeat scroll -92px -52x"});
							break;
						default:
							// statements_def
							break;
