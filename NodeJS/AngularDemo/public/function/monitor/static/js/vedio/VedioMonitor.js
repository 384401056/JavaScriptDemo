...
(function () {
    VedioMonitor = {
        ...
        initialPlugin: function () {
            if (-1 == WebVideoCtrl.I_CheckPluginInstall())return "Win32" == navigator.platform || "Windows" == navigator.platform ? $("#divPlugin").html("<div class='pluginLink'><label name='laPlugin' onclick='window.open(\"/Upfiles/Controls/WebComponents.exe\",\"_self\")' class='pluginLinkSel' >\u8bf7\u70b9\u51fb\u6b64\u5904\u4e0b\u8f7d\u63d2\u4ef6\uff0c\u5b89\u88c5\u65f6\u8bf7\u5173\u95ed\u6d4f\u89c8\u5668<label></div>") :
                $("#divPlugin").html("<div class='pluginLink'><label name='laPlugin' onclick='' class='pluginLink' onMouseOver='' onMouseOut=''>\u8bf7\u70b9\u51fb\u6b64\u5904\u4e0b\u8f7d\u63d2\u4ef6\uff0c\u5b89\u88c5\u65f6\u8bf7\u5173\u95ed\u6d4f\u89c8\u5668<label></div>"), !1;
        ...
        getDynViedoChannels: function (orgID) {
                   ...
                   var b = $("#list-camera");
                    ...
                    $.each(a.data,
                        function (a, d) {
                            ...
                            $(e).appendTo(b);
                            m_DeviceID[m_iDigitalChannelNum] = d.channelID;
