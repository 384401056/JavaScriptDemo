...
$(function() {
    var data = {"g_currChannelIP":'60.160.227.28',"g_currChannelPort":8090,"g_currRTSPPort":554,
                "g_currChannelID":1,"g_currChannelUser":'admin',"g_currChannelPassword":'yhzx@888',
                "g_currIsPTZ":1,"g_currBitStream":1};
    var a = PopupVideo;
    a.initPlugin(400, 225, "divPlugin");
    a.initParams(data);
    a.setPTZControl();
